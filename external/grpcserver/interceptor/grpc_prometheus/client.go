...
func init() {
	prom.Register(DefaultClientMetrics.clientStartedCounter)
	prom.Register(DefaultClientMetrics.clientHandledCounter)
	prom.Register(DefaultClientMetrics.clientStreamMsgReceived)
	prom.Register(DefaultClientMetrics.clientStreamMsgSent)
}
