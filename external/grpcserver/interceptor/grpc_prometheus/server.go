...
func init() {
	prom.Register(DefaultServerMetrics.serverStartedCounter)
	prom.Register(DefaultServerMetrics.serverHandledCounter)
	prom.Register(DefaultServerMetrics.serverStreamMsgReceived)
	prom.Register(DefaultServerMetrics.serverStreamMsgSent)
}
